...
Menu.prototype.set_perp_wh_vals = function(wh_array){
	this.inv_rec.set_perp_wh_vals(wh_array);
};

Menu.prototype.set_perp_xy_vals = function(perp_xy_array){
	this.inv_rec.set_perp_xy_vals(perp_xy_array);
};
