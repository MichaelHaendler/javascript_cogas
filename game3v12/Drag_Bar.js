...
Drag_Bar.prototype.drag = function(mouse_x,mouse_y,mlc) {
	...
	//if(this.properly_clicked(mouse_x,mouse_y) && this.have_seen_proper_first_click_before()){
		...
		change_x_by = diff_x2 - diff_x1;
		change_y_by = diff_y2 - diff_y1; 
	...
	return [change_x_by,change_y_by];
...
Drag_Bar.prototype.draw_ssi_on_given_canvas = function(given_ctx){

	given_ctx.drawImage(this.bar_canvas,
	this.x_loc_on_menu, 
	this.y_loc_on_menu ,
	this.bar_canvas.width,
	this.bar_canvas.height);
