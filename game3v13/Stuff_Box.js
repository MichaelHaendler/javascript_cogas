...
Stuff_Box.prototype.set_offsets = function(x,y){
	...
	// pw.print("(box) this.x is: " + this.x);
	// pw.print("(box) this.y is: " + this.y);

	if(this.item != null){
		this.item.set_offsets(x,y);
	}
}
...
Stuff_Box.prototype.add_item = function(new_item){
	...
	//console.log("enough_of_the_box_is_filled is: " + enough_of_the_box_is_filled);
	// console.log("mlc is: " + mlc);

	// if(this.item == null){
	// 	console.log("this.item is null");
	// }
	// else{
	// 	console.log("this.item is NOT null");
	// }
	...
	//if(this.contains_a_quarter_or_more(new_item) && mlc == false && this.item == null){
	  //if(enough_of_the_box_is_filled && mlc == false && this.item == null){
	  	...
	  	//console.log("new_item.name is: " + new_item.name);
	  	//var res = this.item == null; 
	  	// var res = (mlc == false && this.item == null);
	  	// console.log("res is: " + res);

	  if(mlc == false && this.item == null){

	  	//console.log("mlc is false and this.item is null");

		//console.log("ADDING ITEM!!!!!!!!!!");
		//add item;
		this.item = new_item;

		//console.log("adding the new item, and it's name is: " + this.item.name);

		//this.item.set_to_inactive();

		// var test = this.item != null ? true : false; 
		// console.log("1 is item not null? " + test); 
		...
		// var test = this.item != null ? true : false; 
		// console.log("2 is item not null? " + test); 
		...
		this.item.draw_at_x = this.draw_at_x + (w_diff/2);
		this.item.draw_at_y = this.draw_at_y + (h_diff/2);

	}
	//for testing only
	// else{
	// 	console.log("and we're NOT getting in");
	// }

	//console.log("not getting into if statement")
...
Stuff_Box.prototype.take_item = function(mouse_x,mouse_y,mlc){
	...
	//--if there even is an item in there, 
	//--and the box contains the mouse, 
	//--and the item contains the mouse,
	//--and there wasn't a left click but now is...
	...
	if(this.item != null &&
	   ...
	   this.item.properly_clicked(mouse_x,mouse_y)){
	   	...
	   	if(gen_obj != null){
	   		GID.add_item(gen_obj);
	   		gen_obj = null;//not needed, but doing it anyway. 
	   	}
		...
		//console.log("Stuff_Box.prototype.take_item getting into here for some reason?");
...
Stuff_Box.prototype.draw_on_inventory_rect = function(inv_rect_ctx){
	...
	// console.log("this.draw_at_x is: " + this.draw_at_x);
	// console.log("this.x is: " + this.x);
	...
	if(this.item != null){
		...
		inv_rect_ctx = this.item.draw_on_inventory_rect(inv_rect_ctx);
...
Stuff_Box.prototype.get_item = function() {
