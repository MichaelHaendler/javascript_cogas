...
function Menu(){
	...
	//"only" needed when the rect will be placed ontop of another canvas (that it will be 
	//relative to)
	//this.inv_rec.set_initial_offsets(this.menu_canvas.x,this.menu_canvas.y);
};
