...
Gen_Character.prototype.get_wah = function(){
	return [this.w,this.h];
};

Gen_Character.prototype.get_x_and_y = function(){
	return [this.canvas_loc_x,this.canvas_loc_y];
};

//note: put the rest of build_image_array into Multi_SSI
Gen_Character.prototype.build_image_array = function(){
...
Gen_Character.prototype.draw_ssi = function(curr_ssi){
...
Gen_Character.prototype.run = function(direction,moved){
	...
	// this.canvas_loc_x = 0;
	// this.canvas_loc_y = 0;
Gen_Character.prototype.move_perp = function(direction){
