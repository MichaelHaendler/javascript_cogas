...
function area_holder_insert_grass_v2(tmp_ah){
	...
	var canvas_tb_w = document.getElementById("myCanvas").width / Terrain_Block.w;

	var canvas_tb_l = document.getElementById("myCanvas").height / Terrain_Block.l;
	...
	//grass' width in terms of terr blocks
	var grass_tb_w = w / Terrain_Block.w;

	//grass' length in terms of terr blocks
	var grass_tb_l = l / Terrain_Block.l;
...
function area_holder_insert_rocks_v2(tmp_ah){
	...
	var r_x2 = 5;
	var r_y2 = 8;//3 between it and r_y1 (enough for a person to get through)

	var r_x3 = 5;
	var r_y3 = 9;//1 between it and r_y2 (NOT enough for a person to get through)
