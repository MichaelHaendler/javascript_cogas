...
var grass_sprite = [0,0,16,16];

var rock_sprite = [16,0,16,16];
...
function fill_th_instance_with_stuff(){
	...
	// //insert some rocks 180,100
	// for(var i = 0; i < nos; i+=20){

	// 	th.add_square(180,i,type1,rock_sprite,name_of_sprite_sheet);
	// }
