...
SSI.prototype.graphic_print_all_values = function(){

	pw.print("---------------");

	//upper left corner.
	pw.print("this.start_of_ssi_x is: " + this.start_of_ssi_x);
	pw.print("this.start_of_ssi_y is: " + this.start_of_ssi_y);

	//section of image from image that it orginates from. 
	pw.print("this.s_width is: " + this.s_width);
	pw.print("this.s_height is: " + this.s_height);

	pw.print("this.destination_width is: " + this.destination_width);
	pw.print("this.destination_height is: " + this.destination_height);
